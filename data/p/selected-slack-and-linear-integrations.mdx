...
<div 
    className="flex justify-center bg-primary rounded-sm py-2 px-4 font-bold text-white"
>
  <button
    onClick={() => {
      ...
      window.$crisp.push(["set", "session:event", ["linear-integration"]])
    }}
    className="bg-primaryBlue hover:bg-hoverPrimary rounded-lg py-1 px-4 font-bold text-white"
