...
- your code should be maintanable, reliable, testable, portable, and reusable,
...
Here are my top 5 advices to get you started with code review best practices:
...
4. 400 lines should be the maximum length of pull requests. Beyond 400 lines, it becomes harder to spot flaws because our brain can only handle so much data.
...
- **[Axolo](https://axolo.co)**, an "Essential App" according to Slack (works on GitHub Cloud and Enterprise Server + GitLab Cloud and Self-Hosted) - I am one of Axolo's cofounder, but if you're on Slack test it and let me know what you think!
