...
## ChatGPT Prompts for developer productivity

The five prompts we mention in this article are listed here: [GitHub repository](https://github.com/axolo-co/developer-resources/blob/main/prompt-developer-productivity/developer-prompt-productivity.md)
