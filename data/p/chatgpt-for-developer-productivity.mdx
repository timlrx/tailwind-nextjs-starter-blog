---
title: "10 Ways to use chatGPT for developer productivity"
date: "2023-06-27"
lastmod: "2023-06-27"
...
# ChatGPT for developer productivity and its limitation
...
3. Create PR summaries - with GitHub actions
...
5. Documentation - Explain a piece of code
...
```
You are a specialized code documentation assistant. Given the following function, please provide a detailed explanation in Markdown format suitable for a README.md file. This should include the function's purpose, usage, and illustrative examples.
```
...
Purpose
The factorial function calculates the factorial of a given non-negative integer. In mathematics, the factorial of a non-negative integer n is the product of all positive integers less than or equal to n. It is denoted by n!.
...
```
You are a Jest testing expert. Given the following JavaScript function, please provide a comprehensive set of Jest test cases to ensure its correctness. Include necessary imports, describe blocks, and test cases.
```
...
```
You are a troubleshooting expert. I've encountered the following error while working on my codebase. Here's the error message and context:

*********[Error message and any relevant code or logs]*********

Can you provide an explanation, a solution and suggest steps to resolve this issue?
```
