...
- release of the GitLab integration
- possibility to change the number of reviewers maximum to invite while inviting a team as reviewer on GitHub (default: 4)

## 🔨 Improvements

- do not archive team-specific channel if it was not created by Axolo
- added a warning in the Axolo home if the engineer is not fully onboarded
- ability to prevent engineers from onbaording by themselves on the Axolo home
