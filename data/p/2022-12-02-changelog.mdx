---
title: "GitHub Enterprise Server, Linear integration, awesome improvements and exciting bug fixes..."
date: "2022-12-02"
tags: ["changelog"]
draft: false
summary: "Explore the powerful integration between GitHub Enterprise Server and Linear. Discover how this partnership brings you awesome improvements, exciting bug fixes, and streamlined workflows for your development teams."
---
...
<ImageContainer
  alt="github-enterprise-server"
  src="/blog/static/images/changelog/github-enterprise-server.jpg"
...
- Linear integration: Axolo adds a bookmar to the Linear issue in PR channels
  <ImageContainer
    alt="linear-integration"
    src="/blog/static/images/changelog/linear-integration.jpg"
    classNameDiv="mx-10 lg:mx-20"
    classNameImage=""
    width={2152}
    height={174}
