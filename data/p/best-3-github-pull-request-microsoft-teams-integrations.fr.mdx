...
| Zapier / Automate.io                | 🔴                          | 🔴                      | 🔴                        | 🔴            | 🔴            | ✅                           | 10$ à 600$/Mois      |                           |
...
## **3. <a target="_blank" rel="noopener noreferrer nofollow" href="https://automate.io/integration/github/microsoft-teams">Automate.io</a> et <a target="_blank" rel="noopener noreferrer nofollow" href="https://zapier.com/apps/github/integrations/microsoft-teams">Zapier</a>**

### 😍 Ce que nous aimons :

Il est facile de configurer un workflow personnalisé pour des individus ou pour un canal spécifique, surtout si vous avez déjà Zapier ou [Automate.io](http://Automate.io).
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <Image
    ...
    height="300"
    style={{ borderRadius: "0.5rem", maxWidth: "400px" }}
    alt="Capture d'écran de l'intégration des équipes GitHub"
