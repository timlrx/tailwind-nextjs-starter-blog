---
title: "Top 5 GitHub pull request Slack Integration in 2023 (updated)"
date: "2023-02-17"
...
# A list of 5 Slack GitHub integration

You probably know the official Slack-GitHub integration but there are other options to get notified about GitHub pull requests in Slack.

We've summarized our research into an article and a table for you to easily compare:

| Integration           | Collaborative (channel per PR) | GitHub actions & checks | High PR level view | Access to code | PR Reminders | Standup Recap | Enterprise Ready | Pricing             | Note               |
| --------------------- | ------------------------------ | ----------------------- | ------------------ | -------------- | ------------ | ------------- | ---------------- | ------------------- | ------------------ |
| Axolo                 | ✅                             | ✅                      | ✅                 | 🔴             | ✅           | ✅            | ✅               | 0\$ - 8\$/developer | Best for teams     |
| Official GitHub Slack | 🔴                             | ✅                      | 🔴                 | ✅             | ✅           | 🔴            | ✅               | Free                |                    |
| Toast.Ninja           | 🔴                             | 🔴                      | ✅                 | 🔴             | ✅           | 🔴            | ✅               | 4$/developer        | Provides analytics |
