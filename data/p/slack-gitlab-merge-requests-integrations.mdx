...
| Official Slack GitLab integration         | 🔴                             | 🔴                           | 🔴       | 🔴                 | ✅           | free                |                |
...
Axolo recently added support for GitLab CI. Now for every merge requests Axolo will send a summary when all the CI is finished to the relevant Slack channel. It will look like this:
