...
Axolo recently added support for GitLab CI. Now for every Merge requests Axolo will send a summary whenever all the CI is finished to the relevant Slack channel. It will look like this:
