...
<ImageContainer
  alt="Heroku Proxy Servers"
  src="/blog/static/images/fixedIP/Heroku Proxy Servers.jpg"
...
1.  [https://www.digitalocean.com/community/tutorial-collections/how-to-configure-nginx-as-a-web-server-and-reverse-proxy-for-apache](https://www.digitalocean.com/community/tutorial-collections/how-to-configure-nginx-as-a-web-server-and-reverse-proxy-for-apache)
...
<ImageContainer
  alt="Screenshot dashboard quotaguard"
  src="/blog/static/images/fixedIP/Screenshot dashboard quotaguard.jpg"
  classNameDiv="mx-10 lg:mx-20"
  classNameImage=""
  width={1631}
  height={880}
...
<ImageContainer
  alt="axios-with-proxy-agent"
  src="/blog/static/images/fixedIP/axios-with-proxy-agent.png"
  classNameDiv="mx-10 lg:mx-20"
  classNameImage=""
  width={1430}
  height={1164}
...
<ImageContainer
  alt="octokit proxy calls"
  src="/blog/static/images/fixedIP/octokit proxy calls.png"
  classNameDiv="mx-10 lg:mx-20"
  classNameImage=""
  width={1794}
  height={1478}
