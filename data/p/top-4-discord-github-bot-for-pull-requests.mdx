...
## 3. <a target="_blank" rel="noopener noreferrer nofollow" href="https://www.meta-api.io/">Meta API</a>
...
It does require a bit of time and some code understanding to set it up, here is a full article on how to do that: https://blog.meta-api.io/personalized-github-reminder-for-slack-and-discord.
