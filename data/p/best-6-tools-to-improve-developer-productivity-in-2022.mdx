...
draft: false
summary: "Hi! And welcome to our list of best developer tools for productivity. You will find 6 tools to help your day-to-day as a developer, from improving PR review time, passing through maintaining your flow, to the best software for pair programming."
...
todo un tableau avec toutes les app
...
Axolo takes all of the normal back-and-forths on GitHub/GitLab and Slack to centralize the conversation in ephemeral pull request channels. The service is considered as <NoFollowLink url="slack.com/apps/A01RP0R62N7-axolo-for-github-gitlab?tab=more_info">an essential app by Slack</NoFollowLink> and is an official GitHub Partner. Learn more on the [Axolo website](https://axolo.co).
