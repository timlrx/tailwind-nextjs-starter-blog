...
I developed an application to measure temperature, humidity, water level i.e. under the sink, near washing machine or dishwasher to detect an incident with flood in a home.
A project consists 4 parts - an arduino app, a backend to maintain data from mqtt and the mobile application to present actual metrics and events with alarming data.
...
- [DHT11](https://botland.store/multifunctional-sensors/1886-temperature-and-humidity-sensor-dht11-module--5903351242448.html) - it reads temperature, humidity and heat index.
