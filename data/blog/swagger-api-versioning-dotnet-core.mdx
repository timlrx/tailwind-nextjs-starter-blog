---
title: 'Set up Swagger and API versioning for ASP.NET Core 5 web API'
date: '2021-05-06'
...
API versioning and Swagger for an ASP.NET Core 5 web API. For demo purposes, I have created a new ASP.NET Core 5 API project using Visual Studio.
...
Thanks for reading. If you are interested in the source code, check out the repository [here](https://github.com/Ngineer101/swagger-api-versioning-dotnet-core).
