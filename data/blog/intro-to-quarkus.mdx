...
draft: false
summary: 'How to use the Quarkus framework to build lightweight, cloud-native Java Microservices'
---

## The State of Java

Java: the programming language that's been around for so long, it's due for a government pension. But, despite its age and popularity, Java still gets a lot of flak from developers. In fact, according to the [Stack Overflow 2022 Developer Survey](https://survey.stackoverflow.co/2022/#section-most-loved-dreaded-and-wanted-programming-scripting-and-markup-languages), Java ranked near the bottom for the love/hate ratio, alongside fan-favourites such as PHP and COBOL. Ouch.
...
![Image](https://github.com/adendl/adl-blog/blob/master/public/static/images/quarkus-getting-started/get_request.gif?raw=true)
