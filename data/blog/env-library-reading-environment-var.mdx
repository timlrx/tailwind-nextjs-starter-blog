...
If you have already set up your project in GO and you want to install the library, then all you need to do is **`go get github.com/diarselimi/dev`** and that's it.
...
If you are not ready to contribute then I would appreciate any other support [GitHub repository](https://github.com/diarselimi/env) like give it a star ⭐ if you think it's worth it.
