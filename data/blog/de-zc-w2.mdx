...
Each task is dependent on the completion of the previous task and Workflow Orchestration is essentially the same thing. In the Data Talks Club Week 2 module, [Workflow Orchestration](https://github.com/DataTalksClub/data-engineering-zoomcamp/tree/main/02-workflow-orchestration), this is demosntrated via an ETL pipeline with Mage and the steps involved are as follows:
